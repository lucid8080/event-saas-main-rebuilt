...
function DeleteAccountModal({
  ...
  return (
    <Modal
      ...
      className="gap-0"
    >
      <div className="flex flex-col p-4 pt-8 space-y-3 border-b sm:px-16 items-center justify-center">
        <UserAvatar
          user={{
      ...
      <form
        ...
        className="flex flex-col px-4 py-8 space-y-6 bg-accent text-left sm:px-16"
      >
        <div>
          ...
          <Input
            ...
            autoFocus={false}
            autoComplete="off"
            className="w-full mt-1 bg-background border"
          />
        </div>
